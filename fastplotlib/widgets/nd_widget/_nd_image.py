...
class NDImage(NDGraphic):
    def __init__(
        ...
        *args,
        ...
        processor: type[NDImageProcessor] = NDImageProcessor,
    ...
    def _create_graphic(self):
        match self.processor.n_display_dims:
            case 2:
                cls = ImageGraphic
            case 3:
    ...
    @property
    def n_display_dims(self) -> Literal[2, 3]:
        return self.processor.n_display_dims

    @n_display_dims.setter
    def n_display_dims(self, n: Literal[2 , 3]):
        self.processor.n_display_dims = n

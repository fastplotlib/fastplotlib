...
| dict key | type          | description  |
+==========+===============+==============+
| value    | cmap.Colormap | new colormap |
+----------+---------------+--------------+
...
| dict key | type       | description        |
+==========+============+====================+
| value    | np.ndarray | colormap transform |
+----------+------------+--------------------+
...
| dict key | type                | description |
+==========+=====================+=============+
| value    | tuple[float, float] | new range   |
+----------+---------------------+-------------+
...
| dict key | type        | description      |
+==========+=============+==================+
| value    | str | tuple | new dash pattern |
+----------+-------------+------------------+
...
| dict key | type  | description        |
+==========+=======+====================+
| value    | float | new rotation value |
+----------+-------+--------------------+
